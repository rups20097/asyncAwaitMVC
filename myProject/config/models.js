...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  attributes: {
    createdAt: { type: 'string', columnType: 'datetime', defaultsTo: moment().format('YYYY-MM-DD h:mm:ss') },
    updatedAt: { type: 'string', columnType: 'datetime', defaultsTo: moment().format('YYYY-MM-DD h:mm:ss') },
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'Va6nlQh/H6Wn1xVX4v25JzcjbJA1DyzclAl4EEAT74c='
  },
